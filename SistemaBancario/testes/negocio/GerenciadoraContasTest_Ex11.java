...
public class GerenciadoraContasTest_Ex11 {
	...
	/**
	 * Teste b�sico da tentativa de transfer�ncia de um valor pequeno de uma conta para outra.
	 * 
	 * @author Eric Pavan
	 * @date 17/11/2022
	 */
	@Test
	public void testTransfereValor_Pequeno() {
		...
		/* ========== Execu��o ========== */
		boolean sucesso = gerContas.transfereValor(idConta01, 4, idConta02);
		
		/* ========== Verifica��es ========== */
		assertTrue(sucesso);
		assertThat(conta01.getSaldo(), is(-104.0));
		assertThat(conta02.getSaldo(), is(-96.0));
	}
